...
//declare the functions to persist device states, energy logs, and alerts to the Supabase database. Each function uses the Supabase client to perform upsert or insert operations, handling any errors that may occur during the process.
