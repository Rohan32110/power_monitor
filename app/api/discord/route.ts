...
//Making sure to use the correct import for NextRequest and NextResponse based on your Next.js version. In Next.js 13 and later, you should import them from 'next/server' as shown above.
/**
 * POST /api/discord
